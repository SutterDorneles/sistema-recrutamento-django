...
class Vaga(models.Model):
    ...
    CARGO_CHOICES = [
        ...
        ('Auxiliar de cozinha', 'Auxiliar de cozinha'), ('Auxiliar de limpeza', 'Auxiliar de limpeza'), ('Freelancer', 'Freelancer'), ('instrutor_funcional', 'Instrutor(a) de Treinamento Funcional'), ('estagiario', 'Estagiário'),('administrativo', 'administrativo'),
    ]
